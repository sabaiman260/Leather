          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <Button
                  onClick={() => addToCart({ id: product.id, name: product.name, price: product.price, image: product.images[0] ?? '/placeholder.jpg' }, quantity)}
              ...
              <div className="mt-12 border-t border-border pt-8">
                ...
                >
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                    <select name="rating" className="border border-border px-3 py-2">
